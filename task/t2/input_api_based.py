...
class SearchRequest(BaseModel):
    ...
    search_value: str = Field(description="The value to search for in the specified field (e.g., John, Smith, john@example.com).")
...
def augment_prompt(user_question: str, context: list[dict[str, Any]]) -> str:
    ...
    augmented_prompt = USER_PROMPT.format(context=context_str.strip(), query=user_question)
